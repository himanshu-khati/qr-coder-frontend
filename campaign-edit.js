...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (!campaignId) {
    ...
    window.location.href = "all-campaigns.php";
    return;
  }
  ...
  addSingleVisitorBtn.addEventListener("click", () => {
    window.location.href = `visitor-create-single.php?campaignId=${campaignId}`;
  });
  const addBulkVisitorBtn = document.getElementById("bulkAddVisitorsBtn");
  addBulkVisitorBtn.addEventListener("click", () => {
    window.location.href = `visitor-create-bulk.php?campaignId=${campaignId}`;
  });
});
